...
colnames(cog_md_muts) <- c("sequence_name","sample_date","sample_time","epi_week","lineage","mut_and_type","type","mut") #"major_lineage"
...
seq_muts_df_counts <- seq_muts_df_counts %>% inner_join(prot_lengths, by="protein") # TODO how to keep SYNSNPs?
